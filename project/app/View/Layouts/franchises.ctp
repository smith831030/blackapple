			...
			<div class="container">
				...
				<div id="navbar" class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<li <?php if($current_page=='order') echo 'class="active"';?>><a href="<?php echo $mainPageUrl;?>/Franchises/Order">Order</a></li>
						<li <?php if($current_page=='history') echo 'class="active"';?>><a href="<?php echo $mainPageUrl;?>/Franchises/History">History</a></li>
					</ul>
