...
<body>
	<header class="container">
		<!--<LOGO>-->
		<h1><?php echo $this->Html->image('common/logo.png', array('alt'=>$cakeDescription, 'url'=>'/')); ?></h1>
		<hr />
		<!--</LOGO>-->
	</header>
	...
	<div id="container">
		...
		<footer class="container">
			...
			<p>
				Copyright ⓒ <?php echo $this->Html->link('GAMI','http://gamichicken.com.au')?> all rights reserved
			</p>
		</footer>
		<hr />			
		<!--</FOOTER>-->
