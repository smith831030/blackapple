			...
			<div class="col-md-8 col-md-offset-2">
				<?php echo $this->Form->create('BaPost', array('class'=>'form-horizontal')); ?>
					<fieldset>
						...
						<button type="submit" id="btn_submit" onclick="submitContents(this);" class="btn btn-primary">Add</button>
									...
									<div class="modal-body">
										<table class="table" id="players">
											...
											<tbody>
												...
												<tr>
													<td><input type="checkbox" class="p_id" name="player[]" id="player_<?=$player['BaPlayer']['id'];?>" value="<?=$player['BaPlayer']['id'];?>"></td>
