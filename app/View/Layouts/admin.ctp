		...
		<nav class="navbar navbar-default">
		  <div class="container-fluid">
		    <div class="navbar-header">
		      ...
		      <?php echo $this->Html->image('common/logo.png', array('alt'=>$cakeDescription, 'url'=>'/Admins', 'class'=>'navbar-brand')); ?>
		    </div>
            ...
            <li><a href="/Admins/Category" role="button">Category</a></li>
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Artworks <span class="caret"></span></a>
		          <ul class="dropdown-menu">
		            <li><a href="/Admins/Posts/list">All</a></li>
                <?php foreach($top_categories as $cate):?>
		            	<li><a href="/Admins/Posts/list/<?= $cate['BaPostCategory']['id']?>"><?= $cate['BaPostCategory']['category_title'];?></a></li>
								<?php endforeach;?>
		          </ul>
		        </li>
		      </ul>
